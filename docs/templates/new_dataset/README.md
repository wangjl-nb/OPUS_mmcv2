...
- `../../../templates/new_dataset/validate_ann_info.py`
  - Quick checker for one `ann_file` to validate required keys and shapes.

## Quick Start

1. Copy `../../../templates/new_dataset/my_occ3d_dataset.py` to `loaders/my_occ3d_dataset.py` and rename the class.
2. Copy `../../../templates/new_dataset/config_occ3d_template.py` to your config path and fill in paths/classes/ranges.
