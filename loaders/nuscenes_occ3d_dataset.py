...
class NuScenesOcc3DDataset(BaseDataset):
    def __init__(self,
                 ann_file,
                 data_root,
                 pipeline,
    ...
    def evaluate(self, occ_results, runner=None, show_dir=None, **eval_kwargs):
        warnings.warn(
            'NuScenesOcc3DDataset.evaluate is deprecated; please use mmengine evaluators '
            '(Occ3DMetric) via val_evaluator/test_evaluator.',
            DeprecationWarning,
            stacklevel=2,
        )
