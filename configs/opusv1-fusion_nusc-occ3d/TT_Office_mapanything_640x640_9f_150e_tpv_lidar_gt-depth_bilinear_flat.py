...
ann_pkl_suffix = '_with_depth'  # Keep GT-depth split files for mapanything_extra generation.
...
input_modality = dict(
    use_lidar=True,  # Point branch consumes LiDAR points while MapAnything still uses GT depth extra.
...
]  # Use raw LiDAR points + sweeps for the TPV point branch.
