...
eval_score_thr = 0.1  # Lower binary-occ threshold to avoid dropping valid feature queries early.
...
feature_dims = 128  # PCA-compressed semantic feature dimension.
...
prototype_npz_path = '/root/wjl/Talk2DINO/tartanground_label_ae/artifacts/office79_prototypes_ae128.npz'  # Office-79 PCA prototype dictionary.
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        feature_supervision=dict(
            ...
            prototype_field='latent_128',  # Use PCA/AE latent prototypes.
            ...
            loss_weights=dict(
                cosine=2.0,  # Make feature alignment the main semantic supervision signal.
                mse=0.1,  # Small reconstruction-style stabilizer.
            ),
        ),
    ...
    train_cfg=dict(
        pts=dict(
            ...
            occ_target_cfg=dict(
                ...
                neg_dist_thr=0.20,  # Negative occupied query distance threshold.
            ),
